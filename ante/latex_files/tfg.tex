...
\begin{document}
    ...
    \addtocontents{lof}{\vspace{4mm} {\large Ilustración} ~\hfill\textbf{Página}\par}
    \renewcommand{\listtablename}{Lista de Tablas}
    \newpage \listoftables
    \addtocontents{lot}{\vspace{4mm} {\large Tabla} ~\hfill\textbf{Página}\par}
    
    \input{content/introduction.tex}
    
    \input{content/technology.tex}
    
    \input{content/target.tex}
    
    \input{content/methods.tex}
    
    \input{content/means.tex}
    
    \input{content/intellectualprop.tex}
