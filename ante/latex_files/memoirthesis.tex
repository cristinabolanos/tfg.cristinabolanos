...
\pdfinfo{
   ...
   /Title Diseño de un sistema de riego automatizado aplicado a la viticultura
   /Keywords viticultura;vid;cultivo;riego;automatizado;
...
\makechapterstyle{daleifmodif}{
	...
	\renewcommand\printchaptertitle[1]{\color{gray}\chaptitlefont\raggedright ##1\par}
} 
\makeatother 
...
% UoB guidelines:
%
% MODIFIED (Cristina B.) -- The pages should be numbered consecutively at the bottom centre of the
% page.
\makepagestyle{UNHeader} 
\makeoddfoot{UNHeader}{}{\thepage}{} 
\makeevenfoot{UNHeader}{}{\thepage}{} 
\makeheadrule{UNHeader}{\textwidth}{\normalrulethickness}
\makeevenhead{UNHeader}{\small\textsc{\leftmark}}{}{
    \includegraphics[height=0.8cm]{logos/uclmRed.png}\hspace{0.2cm}
        \includegraphics[height=0.8cm]{logos/esiWhite.png}
}
\makeoddhead{UNHeader}{}{\small\textsc{\rightmark}}{
    \includegraphics[height=0.8cm]{logos/uclmRed.png}\hspace{0.2cm}
        \includegraphics[height=0.8cm]{logos/esiWhite.png}
}
\pagestyle{UNHeader}
